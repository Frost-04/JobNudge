...
class BrowserstackScraper(BaseScraper):
    """Scraper for BrowserStack careers (Workday platform, wd3).
    ...
    Job cards:
        ...
        li.css-1q2dra3
          ...
          [data-automation-id="subtitle"] li.css-h2nt8k   (JRXXXXXX)
    ...
    async def scrape(self) -> list[Job]:
        ...
        try:
            ...
            if not cards:
                self.logger.warning("No BrowserStack job cards found.")
                return jobs
            ...
            for card in cards[:max_jobs]:
                ...
                if self._should_exclude(job.title):
                    ...
                    try:
                        ...
                        self.logger.warning(
                            "Failed to enrich BrowserStack job detail %s: %s",
                            job.url,
                            exc,
                        )
    ...
    def _parse_card(self, card: Tag, source_url: str) -> Job | None:
        ...
        return Job(
            job_id=job_id,
            company=self.company_config.get("name", "BrowserStack"),
            title=title,
            location=location,
            url=url,
