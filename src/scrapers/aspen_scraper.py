...
class AspenScraper(BaseScraper):
    """
    Scraper for AspenTech Careers (Workday platform).
    ...
    The search results page renders job cards:
        ...
        ul[aria-label^="Page"][role="list"]
          li
            ...
            [data-automation-id="subtitle"] li   (R-prefixed job ID)
    ...
    async def scrape(self) -> list[Job]:
        ...
        try:
            ...
            # Give the SPA time to finish rendering cards.
            ...
            if not cards:
                self.logger.warning("No AspenTech job cards found.")
                return jobs
            ...
            for card in cards[:max_jobs]:
                ...
                if self._should_exclude(job.title):
                    ...
                    try:
                        ...
                        self.logger.warning(
                            "Failed to enrich AspenTech job detail %s: %s",
                            job.url,
                            exc,
                        )
    ...
    def _parse_card(self, card: Tag, source_url: str) -> Job | None:
        ...
        # Job ID from the subtitle list (R-prefixed like "R8897").
        job_id = ""
        ...
        return Job(
            job_id=job_id,
            company=self.company_config.get("name", "AspenTech"),
            title=title,
            location=location,
            url=url,
