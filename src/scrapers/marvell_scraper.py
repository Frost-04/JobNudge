...
class MarvellScraper(BaseScraper):
    """Scraper for Marvell careers (Workday platform, wd1).
    ...
    Job cards:
        ...
        li.css-1q2dra3
          ...
          [data-automation-id="subtitle"] li   (job requisition ID)
    ...
    async def scrape(self) -> list[Job]:
        ...
        try:
            ...
            if not cards:
                self.logger.warning("No Marvell job cards found.")
                return jobs
            ...
            for card in cards[:max_jobs]:
                ...
                if self._should_exclude(job.title):
                    ...
                    try:
                        ...
                        self.logger.warning(
                            "Failed to enrich Marvell job detail %s: %s",
                            job.url,
                            exc,
                        )
    ...
    def _parse_card(self, card: Tag, source_url: str) -> Job | None:
        ...
        # Job ID from the subtitle list items (e.g. "2600699" or "R026183").
        job_id = ""
        ...
        return Job(
            job_id=job_id,
            company=self.company_config.get("name", "Marvell"),
            title=title,
            location=location,
            url=url,
